...
class PDFViewer {
  ...
  constructor(options) {
    ...
    this._minScale = MIN_SCALE; // mặc định 0.1
    this._maxScale = MAX_SCALE; // mặc định 10.0
  ...
  updateScale({
    ...
    newScale = MathClamp(newScale, this._minScale, MAX_SCALE);
...
class Toolbar {
  ...
  #updateUIState(resetNumPages = false) {
    ...
    opts.zoomOut.disabled = pageScale <= this._minScale;
